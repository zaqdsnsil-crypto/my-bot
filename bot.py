...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        ...
        [InlineKeyboardButton("🤣 خنده‌دار", callback_data="menu_funny"),
...
# ==================== گزینه جدید: خنده‌دار ====================
async def funny_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    await query.answer()
    texts = [
    ...
    keyboard = [
        [InlineKeyboardButton("🔄 جوک بعدی 😂", callback_data="menu_funny")],
        [InlineKeyboardButton("🔙 برگشت", callback_data="back_main")]
    ]
    await query.edit_message_text(
        random.choice(texts),
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif data == "menu_funny":
        return await funny_menu(update, context)
